-- Frozen schema 3: the database with matching, read and pin marks, before the user's
-- application status, note and "hidden" (user_version 3). Never change this file together
-- with the code - otherwise the migration tests would check their own present instead of
-- the way there.
CREATE TABLE job (
