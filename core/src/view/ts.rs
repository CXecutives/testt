...
use crate::view::{
    ...
    MatchDetail, OpenTarget, Platform, PortalLogin, PortalPatch, PortalState, ProfileAvailability,
    ProfileCompetence, ProfileCriteria, ProfileDraft, ProfileForm, ProfileInfo, ProfileLanguage,
    ProfileQuality, ProfileSave, ProfileUnderstanding, ProfileWishes, Quota, Reason, ReasonKind,
    ReasonWeight, RemoteWish, ResetSummary, Risk, SettingsPatch, SettingsView, TextRange,
    VaultKind, WorkMode,
};
