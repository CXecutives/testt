 ...
 */
export type ProfileUnderstanding = { competenceCount: number, competences: Array<string>, 
/**
 * Where the terms come from, also parts the form does not show (`stationen`).
 */
sources: Array<ProfileSource>, criteria: Array<Notice>, warnings: Array<Notice>, 
/**
